                    ...
                    <div>
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div
                                    class="box box-body pull-up bg-success bg-brick-dark text-center py-2">
                                    <div class="">
                                    ...
                                    <div>
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" type="text"
                                                wire:model.live.debounce.400ms="amount" placeholder="مثال : 200"
                                                dir="ltr">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div>
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" type="text"
                                                wire:model.live.debounce.400ms="amount2" placeholder="مثال : 200"
                                                dir="ltr">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="px-4 mt-4">
                        <div class="alert text-center">
                            ...
                            <div class="mt-4">
                                ...
                                <a href="#" wire:click="resetUserInvoice"
                ...
                @elseif ($step == 4)
                    <div class="px-4 mt-4">
                        <div class="alert text-center">
                            ...
                            <div class="mt-4">
                                <a href="#" data-bs-dismiss="modal"
                                    wire:click="buttonCancelClicked" class="btn btn-danger">
                                    {{ __('website.cancel') }}
                                </a>
                            </div>
                        </div>
        ...
        <div class="box-footer p-2">
            <div class="pull-right">
                ...
                <button type="button" class="btn btn-success" wire:click="save"
                    wire:loading.attr="disabled" @if ($disableSaveButton) disabled @endif>
                    @lang('website.save')
                </button>
