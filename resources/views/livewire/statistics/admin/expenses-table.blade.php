  ...
  <div class="d-flex mobile-display-block justify-content-around">
    <div class="col-xl-5 col-12 mobile-display-block">
      <div class="box box-body custom-card">
        ...
        <div class="progress-bar bg-danger" role="progressbar" style="width:{{$percentage_change_based_on_avarage}}; height: 4px;" aria-valuenow="" aria-valuemin="50" aria-valuemax="100"></div>
        </div>
      ...
      <div class="col-xl-5 col-12 mx-4 mobile-display-block ">
        <div class="box box-body custom-card">
          ...
          <div class="progress progress-xxs mt-0 mb-10">
          <div class="progress-bar {{$this->percentage_change_based_on_avarage <= 0 ? 'bg-success':'bg-danger'}}" role="progressbar" style="width:{{$this->percentage_change_based_on_avarage}}; height: 4px;" aria-valuenow="" aria-valuemin="50" aria-valuemax="100"></div>
          </div>
          <div class="fs-12" ><i class="{{$this->percentage_change_based_on_avarage <= 0 ? 'ion-arrow-graph-down-left text-success':'ion-arrow-graph-up-right text-danger'}} me-1"></i>
            <span dir="ltr" class="px-1 {{$this->percentage_change_based_on_avarage <= 0 ? 'text-success':'text-danger'}}">
             {{$this->percentage_change_based_on_avarage}}
           </span>
  ...
  <x-datatable :paginated-data=null>
      ...
      <x-slot name="navBar">
         ...
         <div class="d-flex align-items-center justify-content-center" style="min-width:175px" >
             <select class="form-select d-inline bg-lightest text-white" wire:model="selected_nas_id">
...
<!-- Create Expense Modal -->
                       ...
                       <div>
                           <div class="input-group p-0">
                               <div class="input-group-addon">
                                   ...
                                   <select x-data="{ type: null, hasSelected: false }" class="form-select" id="type" wire:model="nas_id" x-model="type" @change="hasSelected = true">
   ...
   <!-- Create Expense Modal -->
      ...
      <x-slot name="thead">
          <x-table-thead :columns="__('new_trans.expenses.datatable.admin_expense_table_head')">
                  ...
                  <tr>
                        ...
                        <div class="custom-popover-container text-center">
                            ...
                            <div class="dropdown-menu dropdown-menu-end fw-bold  text-center"  aria-labelledby="dropdown" >
                                <a href="#" class="dropdown-item py-4 fw-bold" data-bs-toggle="modal" data-bs-target="#bs-example-modal-lg_{{$model->id}}">
                                    ...
                                    {{__('new_trans.expenses.info')}}
                                </a>

                                @if($show_info_box && $show_info_box_id == $model->id)
                      ...
                      <div class="modal fade " id="bs-example-modal-lg_{{$model->id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
                        <div class="modal-dialog modal-md">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h4 class="modal-title text-white" id="myLargeModalLabel">{{__('new_trans.expenses.info')}}</h4>
                            ...
                            <div class="modal-body text-center p-2">
                              <div style="display:grid;grid-template-columns:6fr 18fr;">
                                ...
                                <div class="text-xl text-white p-2 my-2 ">
                                  {{__('new_trans.expenses.description.description')}}
                                </div>
                                <div class="p-2 ">
                                  {{ $model->description }}
                                </div>
