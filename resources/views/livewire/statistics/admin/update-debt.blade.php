        ...
        <div class="box  p-3" >
            ...
            <form wire:submit='update'>
                    ...
                    <div class="form-group row">
                        ...
                        <div>
                            <div class="input-group">
                                ...
                                <textarea class="form-control" style="height:125px;" id='description' placeholder="{{trans('new_trans.new_debts.description_placeholder')}}"
                ...
                <div class="p-3 d-flex" style="justify-content:end;">
                    <a href="{{ route($this->redirectTableRouteName()) }}" class="btn btn-danger mx-2">
