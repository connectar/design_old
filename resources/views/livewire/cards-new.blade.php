<form wire:submit="save" novalidate>
    <div class="box bt-1 border-success">
                    ...
                    <div class="form-group row">
                        ...
                        <div>
                            <div class="input-group">
                                ...
                                <select class="selectpickerJs form-select show-tick p-0" wire:model="offer">
                    ...
                    <div class="form-group row">
                        ...
                        <div>
                            <div class="input-group">
                                ...
                                <input class="form-control" type="text" min="1" wire:model="cardsCount">
                            </div>
                        </div>
                    </div>
                    @error('cardsCount')
        ...
        <!-- /.box-body -->
        <x-box-footer cancelRoute="{{ route('admins.cards.groups.index') }}"
