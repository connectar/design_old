<form wire:submit="nextStep">
    <div class="box box-bordered border-danger m-0 no-padding">
        <div class="box-header with-border py-3">
            <h4 class="box-title">
                {{ __('site.devices_index.update_title', ['name'=>$device_name]) }}
            </h4>
        </div>
        <div class="box-body">
            @if ($step == 1)
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="form-group row">
                            <label for="type" class="form-label">
                                {{ __('site.devices_index.schema_type') }}
                            </label>
                            <div>
                                <select class="form-select" wire:model="schema">
                                    <option value="">
                                        {{ __('site.devices_index.select_schema') }}
                                    </option>
                            ...
                            <div>
                                <div class="input-group">
                                    ...
                                    <select class="form-select" wire:model="nas_serial">
                                        <option value="">
                                            {{ __('site.devices_index.select_connected_nas') }}
                                        </option>
