    ...
    @if (count($designs))
        <div class="row" style="margin-top: 5px;margin-bottom: 10px">
            <div class="col-sm-12 col-md-6">
                <a href="{{ route('cafe.cards.design.create') }}" class="btn btn-success btn-md ml-5 fw-bold">
        ...
        <div class="row">
            @foreach ($designs as $index => $design)
                <div class="col-lg-4 col-sm-6">
                    <div class="box text-center @if (($index + 1) % 2 == 0) bt-1 @else bb-1 @endif border-success">
                                        ...
                                        @if ($key === 'qr')
                                            <div class="cardItems" style="{{ $design['itemsStyle'][$key] }}">
                                                <img src="data:image/svg+xml;base64,{!! $qr !!}"
                                                    style="width:{{ $design['items']['items']['qr']['width'] ?? '200' }};height:{{ $design['items']['items']['qr']['height'] ?? '200' }}">
                                            </div>
                                        @else
                                            <div class="cardItems" style="{{ $design['itemsStyle'][$key] }}">
                                                <div dir="auto">
                        ...
                        <div class="box-footer justify-content-center d-flex no-border">
                            ...
                            <a class="btn btn-sm btn-danger" wire:click="showDeletedBox('{{ $design['id'] }}')">
    ...
    @else
        <div class="box bt-3 border-primary text-center">
            <div class="box-body py-50">
                ...
                <a href="{{ route('cafe.cards.design.create') }}" class="btn btn-success">
