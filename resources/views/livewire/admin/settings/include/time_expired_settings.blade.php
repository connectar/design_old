<form wire:submit="saveTimeExpiredSettings">
    <div class="box p-0 border-dark">
        ...
        <div class="box-body p-0">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" wire:model.live.debounce.400ms="time_page_title"
                                placeholder="عفوا تم قطع الخدمه">
                            @error('time_page_title')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" wire:model.live.debounce.400ms="time_header_text"
                                placeholder="عفوا تم قطع الخدمه">
                            @error('time_header_text')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea class="form-control" rows="3" wire:model.live.debounce.400ms="time_main_message"
                                placeholder="لقد استهلكت 100 % من باقتك الاساسيه الشهرية"></textarea>
                            @error('time_main_message')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea class="form-control" rows="2" wire:model.live.debounce.400ms="time_secondary_message"
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="color-picker-wrapper">
                                <input type="color" class="form-control form-control-color"
                                    wire:model.live.debounce.400ms="time_header_bg_color" style="width: 60px;">
                                <input type="text" class="form-control" wire:model.live.debounce.400ms="time_header_bg_color"
                                    placeholder="#c1272d">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="color-picker-wrapper">
                                <input type="color" class="form-control form-control-color"
                                    wire:model.live.debounce.400ms="time_body_bg_color" style="width: 60px;">
                                <input type="text" class="form-control" wire:model.live.debounce.400ms="time_body_bg_color"
                                    placeholder="#fff">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="color-picker-wrapper">
                                <input type="color" class="form-control form-control-color"
                                    wire:model.live.debounce.400ms="time_button_bg_color" style="width: 60px;">
                                <input type="text" class="form-control" wire:model.live.debounce.400ms="time_button_bg_color"
                                    placeholder="#C1272D">
                            </div>
                        </div>
                    </div>
            ...
            <div class="card bg-dark mb-3 ">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" wire:model.live.debounce.400ms="time_show_image"
                                    id="timeShowImage">
                                <label class="form-check-label" for="timeShowImage">
                                    عرض الصورة
                                </label>
                            </div>
                        </div>

                        @if ($time_image_path || $time_image_upload)
                            <div class="image-preview mb-2">
                                @if ($time_image_upload)
                                    <img src="{{ $time_image_upload->temporaryUrl() }}" alt="معاينة">
                                @else
                                    <img src="{{ $time_image_path }}" alt="الصورة الحالية">
                                @endif
                                <button type="button" class="remove-btn" wire:click="removeTimeImage">
                                    <i class="fa fa-times"></i>
                                </button>
                            </div>
                        @endif

                        <div class="upload-zone" onclick="document.getElementById('time_image_input').click()">
                        ...
                        <input type="file" id="time_image_input" wire:model.live.debounce.400ms="time_image_upload" accept="image/*"
                            style="display: none;">
                        @error('time_image_upload')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                        ...
                        <div class="mt-2" dir="ltr">
                            ...
                            <input type="text" class="form-control" wire:model.live.debounce.400ms="time_image_path"
                        ...
                        <div class="mt-3 p-3 border rounded bg-light">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <span class="badge bg-primary">{{ $time_image_size ?? 100 }}%</span>
                            </div>
                            <input type="range" min="10" max="100" step="5"
                                class="form-range" wire:model.live.debounce.200ms="time_image_size">
                            <div class="d-flex justify-content-between">
                                <small class="text-muted">10%</small>
                                <small class="text-muted">100%</small>
                            </div>
                            @error('time_image_size')
                    ...
                    <div>
                        ...
                        @if ($time_background_image || $time_background_upload)
                            <div class="image-preview mb-2">
                                @if ($time_background_upload)
                                    <img src="{{ $time_background_upload->temporaryUrl() }}" alt="معاينة">
                                @else
                                    <img src="{{ $time_background_image }}" alt="الخلفية الحالية">
                                @endif
                                <button type="button" class="remove-btn" wire:click="removeTimeBackground">
                                    <i class="fa fa-times"></i>
                                </button>
                            </div>
                        @endif

                        <div class="upload-zone" onclick="document.getElementById('time_bg_input').click()">
                            <i class="fa fa-upload fa-3x  mb-2"></i>
                            <p class="mb-0">انقر لرفع صورة خلفية</p>
                            <small class="text-muted">أو اسحب الصورة هنا (حجم أقصى 5MB)</small>
                        </div>
                        <input type="file" id="time_bg_input" wire:model.live.debounce.400ms="time_background_upload"
                            accept="image/*" style="display: none;">
                        @error('time_background_upload')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                        ...
                        <div class="mt-2" dir="ltr">
                            ...
                            <input type="text" class="form-control" wire:model.live.debounce.400ms="time_background_image"
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" wire:model.live.debounce.400ms="time_button_text"
                                placeholder="لوحة التحكم">
                            @error('time_button_text')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3" dir="ltr">
                            ...
                            <input type="text" class="form-control text-left" wire:model.live.debounce.400ms="time_button_url"
                                placeholder="/users/login">
                            @error('time_button_url')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    </div>
            ...
            <div class="card bg-dark mb-3 ">
                ...
                <div class="card-body">
                    @foreach ($time_custom_buttons as $index => $button)
                        <div class="position-relative bg-light mb-4 ">

                            <button type="button" class="delete-btn" {{-- wire:click="removeTimeCustomButton({{ $index }})" --}}
                                x-on:click="confirmDeleteTimeCustomButtonBtn({{ $index }})">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control"
                                        wire:model.live.debounce.400ms="time_custom_buttons.{{ $index }}.text"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control"
                                        wire:model.live.debounce.400ms="time_custom_buttons.{{ $index }}.url"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group p-0">
                                        ...
                                        <select class="form-select"
                                            wire:model.live.debounce.400ms="time_custom_buttons.{{ $index }}.icon">
                                            <!-- Social -->
                                    ...
                                    @error("time_custom_buttons.{$index}.icon")
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="color-picker-wrapper">
                                        <input type="color" class="form-control form-control-color"
                                            wire:model.live.debounce.400ms="time_custom_buttons.{{ $index }}.color"
                                            style="width: 60px;">
                                        <input type="text" class="form-control"
                                            wire:model.live.debounce.400ms="time_custom_buttons.{{ $index }}.color"
                                            placeholder="#25D366">
                                ...
                                <div class="col-12">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox"
                                            wire:model.live.debounce.400ms="time_custom_buttons.{{ $index }}.enabled"
                                            id="timeBtn{{ $index }}Enabled">
                                        <label class="form-check-label" for="timeBtn{{ $index }}Enabled">
                                            تفعيل هذا الزر
                                        </label>
                                    </div>
                                </div>
                    ...
                    <!-- Add New Button -->
                    <div class="custom-button-card add-button-card text-center py-4" wire:click="addTimeCustomButton">
