<div>
    ...
    @php
        $systemDistributorCurrency = getCurrencyNameByCountryCode(auth('admin')->user()->sysdist_country);
    @endphp
    <div class="d-flex mobile-display-block justify-content-around">
        ...
        <div class="col-xl-4 col-12 mobile-display-block">
            <div class="box box-body custom-card">
                ...
                <p class="fs-26">
                    ...
                    <span class="text-sm">{{ $systemDistributorCurrency }}</span>
                </p>

                <div class="progress progress-xxs mt-0 mb-10">
                    <div class="progress-bar bg-success" role="progressbar" style="width:80%; height: 4px;"
                        aria-valuenow="" aria-valuemin="50" aria-valuemax="100"></div>
                </div>
        ...
        <div class="col-xl-4 col-12 mobile-display-block">
            <div class="box box-body custom-card">
                ...
                <div class="progress progress-xxs mt-0 mb-10">
                    <div class="progress-bar bg-danger" role="progressbar" style="width:5%; height: 4px;"
                        aria-valuenow="" aria-valuemin="50" aria-valuemax="100"></div>
                </div>
                <div class="fs-12"><i class="glyphicon glyphicon-info-sign text-primary me-1 "></i>
                    <span class="px-2 ">
                    ...
                    <div class="col-md-6 col-sm-12 ">
                        <div class="col-md-6">
                            <label for="date-range"
                                class="form-label p-2">{{ __('new_trans.started_at') }}</label><span
                                class="text-primary">{{ __('new_trans.started_at_etc') }} </span> :</label>
                            <input type="text" id="date-range" wire:model.prevent.debounce.500ms="created_at_range"
