                ...
                <div>
                    <div>
                        <div class="input-group p-0">
                            ...
                            <select class="form-select" id="locale" wire:model.prevent="locale">
{{-- $locale_ is variable that get from Livewire/Cafe/Settings/ChangeLangTab, mount method that get the current user database langauge like "ar" --}}
