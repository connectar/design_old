<div class="box bt-1 border-success">
    <x-box-header back-text="{{ __('adding.card.card_designs_back') }}" title="{{ __('adding.card.design') }}"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input class="form-control set-card-name" data-name="card" data-property="name" type="text"
                            value="تصميم جديد" wire:model="name">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-bs-toggle="tab" href="#serialContent" role="tab">
                            <span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#priceContent" role="tab">
                            <span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#qrContent" role="tab">
                            <span>
                        ...
                        <div class="p-15">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 col-6">
                                    <input class="changeSerialValue form-control" type="text" value="999 999 99"
                            ...
                            <div class="form-group row">
                                <div class="col">
                                    ...
                                    <div class="">
                                        <input class="item-change form-control" type="number" value="14"
                                ...
                                <div class="col">
                                    ...
                                    <input class="item-change form-control p-0" type="color" value="#563d7c"
                                        data-name="serial" data-property="color" style="height: 32px;">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="p-15">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col">
                                    ...
                                    <input class="item-change form-control p-0" type="color" value="#563d7c"
                                        data-name="price" data-property="color" style="height: 32px;">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="p-15">
                            ...
                            <div class="form-group row">
                                <div class="col">
                                    ...
                                    <input class="item-change form-control" type="number" value="75"
                                        data-name="qr" data-property="width">
                                </div>
                                <div class="col">
                                    <label for="cardFontSizeLabel">
                                    ...
                                    <input class="item-change form-control" type="number" value="75"
                                        data-name="qr" data-property="height">
                                </div>
                                {{-- <div class="col">
                                    <label>
                                        {{ __('adding.card_design.colorLabel') }}
            ...
            <div class="col-md-6">
                <div class="card-container-background" style="margin: auto">
                    <div id="cardContainer" class="card-container" dir="auto">
                        <div class="cardItems draggable" id="serial" data-name="serial" style="font-size: 14pt;">
                            <div>
                                99999999
                            </div>
                        </div>
                        <div class="cardItems draggable" id="qr" data-name="qr" data-x="30"
                            data-y="70" style="opacity: 0;">
                            <div style="position: relative; width: 100%; height: 100%;">
                                <img src="data:image/svg+xml;base64,{!! $qr !!}"
                                    style="width: 100%; height: 100%;">
                            </div>
                        </div>
                        <div class="cardItems draggable" id="price" data-name="price" data-x="30"
                            data-y="70" style="left:30px;top:70px;font-size: 14pt;">
                            <div>
                                80
                            </div>
                        </div>
    ...
    <x-box-footer cancelRoute="{{ route('admins.cards.design.index') }}" submitText="{{ __('website.save') }}"
        submitClass="btn-success addCardDesign" />
</div>
