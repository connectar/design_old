...
@section('content')
    ...
    <form id="DistributerForm"
        action="{{ route('admins.distributors.update', ['distributor' => $model->id]) }}"
        method="POST" novalidate>
        @method('PUT')
        @csrf
        <div class="box bt-1 border-success">
            <x-box-header back-text="{{ __('adding.distributor.all_title') }}"
                title="{{ __('adding.distributor.edit_title') }}"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group row">
                                            ...
                                            <div>
                                                ...
                                                <div class="error text-primary" style="font-size: 12px;">
                                                    {{ __('adding.distributor.ignore_password') }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div>
                                                <div class="input-group">
                                                    <input class="form-control" type="text"
                                                           ...
                                                           value="{{ $model->phone }}">
                                                    <input value="{{ $model->region }}" type="hidden" name="data[region]" id="region">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div>
                                                <div class="input-group">
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach ($nas as $nas)
                                                            <option value="{{ $nas['id'] }}"
                                                                    @if (in_array($nas['id'], $selectedNas)) selected @endif>
                                                                {{ $nas['name'] }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div>
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control" type="number"
                                                        ...
                                                        dir="rtl" value="{{ $model->profit_price }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea class="form-control" rows="3" id="notes"
                                                name="notes">{{ optional($model->note)->content }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function(){
            ...
            let userRegion = "@php echo strtolower($model->region ?? ''); @endphp";
