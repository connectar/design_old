...
@section('content')
    <form id="FormSubmit" action="{{ route('admins.offers.store') }}" method="POST">
        @method('POST')
        @csrf
        <div class="box">
            <x-box-header back-text="{{ __('adding.offer.offers_title') }}" title="{{ __('adding.offer.create_title') }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div>
                                    <div class="input-group">
                                        ...
                                        <select class="selectpickerJs form-select show-tick p-0"
                                            x-model="disable_user_after_renew" name="disable_user_after_renew">
    ...
    <script>
        function addNewOffer() {
            return {
                offer: {
                    speed: '',
                    disconnect_quota_mb_after_time_expire: {{ (int) config('offers.broadband_expire_quta', 250) }},
                    expire_quta_details: {
