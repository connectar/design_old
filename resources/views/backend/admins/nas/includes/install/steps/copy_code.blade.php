@inject('QrCode', 'SimpleSoftwareIO\QrCode\Facades\QrCode')<div class="mt-20 text-center">
    ...
    {{-- <div>
        <img style="width: 80px;height: 80px;" src="data:image/png;base64, {!! base64_encode(
            QrCode::encoding('UTF-8')->format('png')->errorCorrection('L')->size(80 * 80)->generate($installCode),
        ) !!} ">
    </div> --}}
    <div>
