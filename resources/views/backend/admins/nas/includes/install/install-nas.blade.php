        ...
        <div class="tab-wizard wizard-circle wizard clearfix">
            <div class="steps clearfix">
                <ul role="tablist">
                    ...
                    <li role="tab" class="@if ($step == $currentStep) first current @else disabeld @endif"
                        aria-disabled="false" aria-selected="@if ($step == $currentStep) true @else false @endif">
                        <a href="#">
            ...
            <div class="content clearfix">
                <div class="row">
                    <div class="box">
                        <!-- /.box-header -->
                        <div class="box-body">
                            @include("backend.admins.nas.includes.install.steps.{$currentStep}")
                        </div>
                        <!-- /.box-body -->
                    </div>
