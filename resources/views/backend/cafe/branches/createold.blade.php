...
@section('content')
    <form id="FormSubmit" action="{{ route('cafe.branches.store') }}" method="POST" novalidate>
        @method('POST')
        @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div>
                                        <div class="input-group">
                                            ...
                                            <select class="selectpicker form-select show-tick p-0"
                                                name="network[using]" id="network_using" readonly>
                                                @foreach (trans('adding.register.cafe_using_values') as $key => $value)
                                                    <option value="{{ $key }}">
                                                        {{ $value }}
                                                    </option>
                                                @endforeach
