        ...
        <div class="navbar-custom-menu r-side">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown ">
                    <a href="#" class="waves-effect px-4 waves-light dropdown-toggle btn-primary-light "
                        ...
                        @if (App::getLocale() == 'ar')
                            ...
                            <div class=" text-sm px-1 xs-none"> {{ __('languages.locale.ar.name') }} </div>
                        @else
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="30" zoomAndPan="magnify" viewBox="0 0 30 30.000001" height="40"
                                preserveAspectRatio="xMidYMid meet" version="1.0">
                        ...
                        <li class="header">
                            <div class="p-20">
                                <div class="flexbox">
                                    ...
                                    @if(auth('admin')->user()->unreadNotifications()->count() > 0)
                                        <div>
                                            <a style="font-size: 11px" href="{{route('managers.mark_all_as_read')}}" class="text-danger">{{__('notification.read_all')}}</a>
                                        </div>
                                    @endif
                                </div>
                            </div>
                        ...
                        <li>
                            ...
                            <ul class="menu sm-scrol" style="min-width: 250px;">
                                @forelse(auth('admin')->user()->unreadNotifications as $notification)
                                    <li>
                                        <a href="@if(isset($notification->data['route'])) {{$notification->data['route']}}@else javascript:void(0) @endif">
                                            <i class="fa fa-users text-info"></i>
                                            {{$notification->data['message']}}
                                            <span style="opacity: .5;font-size: 10px;width: 100%;display: block;text-align: left">{{\Carbon\Carbon::parse($notification->created_at)->diffForHumans()}}</span>
                                        </a>
                                    </li>
                                @empty
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu animated flipInX">
                        <li class="user-body">
                            <a class="dropdown-item" href="{{ route('managers.show', 66666) }}"><i
