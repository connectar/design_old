		...
		<section class="content">
			<div class="row">
							...
							<div class="box-body">
								<div class="d-md-flex justify-content-between align-items-center d-inline-block">
									...
									<div>
										...
										<h4 class="mb-0"><span class="text-success">0.0000245</span> <span class="ms-5">$1.25</span></h4>
									</div>
									<div class="d-lg-block d-none">
										<p class="mb-5 text-fade">24h Change</p>
										<h4 class="mb-0"><span class="text-success">0.0000045</span> <span class="ms-5 text-success">+0.25</span></h4>
									</div>
									<div class="d-lg-block d-none">
					...
					<div class="col-xl-8 col-12">
						...
						<div class="box">
							<div class="box-header with-border">
							  <h4 class="box-title">Quick Quote</h4>
					...
					<div class="col-12">
						<div class="box">
						  <div class="box-body tickers-block">
							  <ul id="webticker-8">
								<li><span class="potential-income">Indicative potential income:</span></li>
								<li><span class="indicative-value">ABYR 12.84 <span class="text-danger">-1.14 &#40;0.9%&nbsp;<i class="fa fa-caret-down"></i>&#41;</span></span></li>
								<li><span class="indicative-value">IDHR 129.84 <span class="text-success">+81.14 &#40;0.19%&nbsp;<i class="fa fa-caret-up"></i>&#41;</span></span></li>
						...
						<div class="box direct-chat direct-chat-info">
							...
							<div class="box-body">
							  ...
							  <div class="direct-chat-messages" id="direct-chat">
								...
								<div class="direct-chat-msg clearfix right mb-30">
							  <div class="clearfix mb-15">
