...
<body class="theme-warning bg-dark-body dark-skin">
        ...
        <div class="container">
            <div class="row mt-30 align-items-center">
                ...
                <div class="col-lg-6 col-12">
                    ...
                    <p class="text-white fs-18 mb-50">The ultimate goal of CryptoCoin is to be the all-in-one solution
                        and offer a wide array of services from market to finance.</p>
                    <p class="text-white-50 fs-16 mb-50">Our clients – both corporate and private ones – will access all
                        the services they need from a single platform. Blockchain technology gives us the chance to make
                        your finances grow faster and give better returns.</p>
                </div>
            </div>
        </div>
    </section> --}}
    ...
    {{-- <section class="py-100 bg-img countnm-bx" data-aos="fade-up"
        style="background-image: url(../images/front-end-img/map.png); background-position: top center;">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-7 col-12 mb-50">
                    <h1 class="mb-15 text-white text-center">Run Your ICO from Anywhere</h1>
                    <hr class="w-100 bg-primary">
                    <p class="text-white text-center fs-18 mb-50">Internet access has been declared a human right by
                        United States, its start-up culture is booming and its citizens and businesses have been able to
                        enjoy the use of many streamlined digital public services.</p>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="box bg-dark box-body pull-up">
                        ...
                        <div class="tradingview-widget-container">
                            ...
                            <div class="tradingview-widget-copyright"><a
                                    href="https://in.tradingview.com/symbols/BTCUSD/?exchange=BITSTAMP" rel="noopener"
                                    target="_blank"><span class="blue-text">BTCUSD Rates</span></a> by TradingView</div>
                ...
                <div class="col-12 col-md-6 col-xl-3">
                    <div class="box bg-dark box-body pull-up">
                        ...
                        <div class="tradingview-widget-container">
                            <div class="tradingview-widget-container__widget"></div>
                            <div class="tradingview-widget-copyright"><a
                                    href="https://in.tradingview.com/symbols/ETHUSD/?exchange=BITSTAMP" rel="noopener"
                                    target="_blank"><span class="blue-text">ETHUSD Rates</span></a> by TradingView</div>
                            <script type="text/javascript"
                                src="https://s3.tradingview.com/external-embedding/embed-widget-single-quote.js" async>
                                {
                ...
                <div class="col-12 col-md-6 col-xl-3">
                    <div class="box bg-dark box-body pull-up">
                        ...
                        <div class="tradingview-widget-container">
                            <div class="tradingview-widget-container__widget"></div>
                            <div class="tradingview-widget-copyright"><a
                                    href="https://in.tradingview.com/symbols/LTCUSDT/?exchange=BINANCE" rel="noopener"
                                    target="_blank"><span class="blue-text">LTCUSDT Rates</span></a> by TradingView
                            </div>
                            <script type="text/javascript"
                                src="https://s3.tradingview.com/external-embedding/embed-widget-single-quote.js" async>
                                {
                ...
                <div class="col-12 col-md-6 col-xl-3">
                    <div class="box bg-dark box-body pull-up">
                        ...
                        <div class="tradingview-widget-container">
                            <div class="tradingview-widget-container__widget"></div>
                            <div class="tradingview-widget-copyright"><a
                                    href="https://in.tradingview.com/symbols/XRPUSDT/?exchange=BINANCE" rel="noopener"
                                    target="_blank"><span class="blue-text">XRPUSDT Rates</span></a> by TradingView
                            </div>
                            <script type="text/javascript"
                                src="https://s3.tradingview.com/external-embedding/embed-widget-single-quote.js" async>
                                {
                ...
                <div class="col-12 col-md-6 col-xl-3">
                    <div class="box bg-dark box-body pull-up">
                        ...
                        <div class="tradingview-widget-container">
                            <div class="tradingview-widget-container__widget"></div>
                            <div class="tradingview-widget-copyright"><a
                                    href="https://in.tradingview.com/symbols/XBTUSD/?exchange=BITMEX" rel="noopener"
                                    target="_blank"><span class="blue-text">XBTUSD Rates</span></a> by TradingView</div>
                            <script type="text/javascript"
                                src="https://s3.tradingview.com/external-embedding/embed-widget-single-quote.js" async>
                                {
                ...
                <div class="col-12 col-md-6 col-xl-3">
                    <div class="box bg-dark box-body pull-up">
                        ...
                        <div class="tradingview-widget-container">
                            <div class="tradingview-widget-container__widget"></div>
                            <div class="tradingview-widget-copyright"><a
                                    href="https://in.tradingview.com/symbols/DOTUSD/?exchange=KRAKEN" rel="noopener"
                                    target="_blank"><span class="blue-text">DOTUSD Rates</span></a> by TradingView</div>
                            <script type="text/javascript"
                                src="https://s3.tradingview.com/external-embedding/embed-widget-single-quote.js" async>
                                {
                ...
                <div class="col-12 col-md-6 col-xl-3">
                    <div class="box bg-dark box-body pull-up">
                        ...
                        <div class="tradingview-widget-container">
                            <div class="tradingview-widget-container__widget"></div>
                            <div class="tradingview-widget-copyright"><a
                                    href="https://in.tradingview.com/symbols/DOGEUSD/?exchange=BITTREX" rel="noopener"
                                    target="_blank"><span class="blue-text">DOGEUSD Rates</span></a> by TradingView
                            </div>
                            <script type="text/javascript"
                                src="https://s3.tradingview.com/external-embedding/embed-widget-single-quote.js" async>
                                {
                ...
                <div class="col-12 col-md-6 col-xl-3">
                    <div class="box bg-dark box-body pull-up">
                        ...
                        <div class="tradingview-widget-container">
                            <div class="tradingview-widget-container__widget"></div>
                            <div class="tradingview-widget-copyright"><a
                                    href="https://in.tradingview.com/symbols/XRPUSD/?exchange=BITFINEX" rel="noopener"
                                    target="_blank"><span class="blue-text">XRPUSD Rates</span></a> by TradingView</div>
                            <script type="text/javascript"
                                src="https://s3.tradingview.com/external-embedding/embed-widget-single-quote.js" async>
                                {
                ...
                <div class="col-xl-3 col-md-6 col-12">
                    <a href="#" class="box bg-dark-body">
                        <div class="box-body">
                            ...
                            <div class="text-white-50 fs-16">It is a long established fact that a reader will be
                                distracted by the readable content of a page when looking at its layout.</div>
                        </div>
                    </a>
                </div>
                <div class="col-xl-3 col-md-6 col-12">
                    ...
                    <div class="pay-bx px-30">
                        ...
                        <div class="d-flex gap-3 mb-50">
                            <a href="#" class="btn btn-dark btn-outline"><img
                                    src="../images/front-end-img/logo-visa.png" class="max-w-50" alt="" /></a>
                            <a href="#" class="btn btn-dark btn-outline"><img
                                    src="../images/front-end-img/logo-mastercard.png" class="max-w-50" alt="" /></a>
                            <a href="#" class="btn btn-dark btn-outline"><img
                                    src="../images/front-end-img/logo-bitcoin.png" class="max-w-50" alt="" /></a>
                            <a href="#" class="btn btn-dark btn-outline"><img
                                    src="../images/front-end-img/logo-ethereum.png" class="max-w-50" alt="" /></a>
                        </div>
                        <h4 class="text-white mb-20">Token Contract Address</h4>
                        <p class="text-white-50 fs-18 mb-20">15xg5x5xbxbxbxb66bdx6b5xb6x6b6</p>
                        <p class="text-white-50 fs-18">The following address is for the STMX token contract. It is NOT a
                            deposit address. Do NOT send tokens to it. To deposit, use the Deposit form in the <a
                                href="#" class="text-primary">Tokensale platform.</a></p>
                    </div>
                </div>
                    ...
                    <div class="col-lg-3 col-12">
                        <div class="widget">
                            ...
                            <ul class="list list-unstyled mb-30">
                                ...
                                <li> <i class="fa fa-envelope"></i> <span>hello@multipurposethemes.com
                                    </span><br><span>support@multipurposethemes.com </span></li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="footer-bottom bg-dark3">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6 col-12 text-md-start text-center"> © 2021 <span class="text-white">
                            Multipurpose Themes</span> All Rights Reserved.</div>
